...
heroku pg:psql -a plastech (To go into database)
cat database.sql | heroku pg:psql -a plastech (catnate database.sql) into heroku database)
cat insertquery.sql | heroku pg:psql -a plastech
CREATE DATABASE FCF;
